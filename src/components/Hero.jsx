    ...
    <div className=" px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-80 pt-28 pb-28 2xl:pt-48 2xl:pb-36 flex lg:justify-between items-center " id='home'>
        <div className='ml-10 md:ml-20 lg:ml-0'>
          ...
          <div className=' mt-44 flex gap-2'>
            ...
            <span className='border rounded-full p-1 md:p-2 md:text-2xl hover:bg-indigo-600 transition-all ease-in-out duration-500 hover:text-white opacity-50 hover:opacity-100'><a href="https://web.facebook.com/profile.php?id=100008095329308"><RiFacebookFill/></a></span>
            <span className='border rounded-full p-1 md:p-2 md:text-2xl hover:bg-indigo-600 transition-all ease-in-out duration-500 hover:text-white opacity-50 hover:opacity-100'><a href="https://www.linkedin.com/in/shek-rasel/"><BsLinkedin/></a></span>
            <span className='border rounded-full p-1 md:p-2 md:text-2xl hover:bg-indigo-600 transition-all ease-in-out duration-500 hover:text-white opacity-50 hover:opacity-100'><a href="https://github.com/ShekRasel"><FaGithub/></a></span>
            </div>
            <div className='w-1/4  border-t-2 mt-5 border-indigo-600'></div>
          </div>
        </div>
